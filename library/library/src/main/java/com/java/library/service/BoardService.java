...
//		}
	...
	// 게시판 글 삭제
	@Override
	public Map<String, Object> boardDelete(@RequestParam Map<String, Object> paramMap, HttpSession session) {
		// 게시물 한개 받기 
...
//		Map<String,Object> userSession = (HashMap<String, Object>) paramMap.get("UserSession");
	...
	// 게시판 글 수정
	@Override
	public Map<String, Object> boardUpdate(Map<String, Object> paramMap, HttpSession session){
