...
//			System.out.println("rstNaverLibraryList : " + rstNaverLibraryList);
...
//		}
		...
		return rstNaverLibraryList;
	}

	// 메인화면에 추천도서 1개 가져오기
	@Override
	public Map<String, Object> mainRecommend(Map<String, Object> paramMap) {
		rstMap = ddi.mainRecommend(paramMap);
		String str = rstMap.get("title").toString();
		String content = Util.removeHtml(str);
		rstMap.put("title", content);
		return rstMap;
	}
	...
	public Map<String, Object> borrowBookInsert(Map<String, Object> paramMap) {
		rstMap = new HashMap<String,Object>();
		rstMap.put("status", ddi.borrowBookInsert(paramMap));
		return rstMap;
	}

	@Override
	public List<Map<String, Object>> mainBestView(Map<String, Object> paramMap) {
		List<Map<String, Object>> rstMap = ddi.mainBestView(paramMap);
		List<Map<String, Object>> returnMap = new ArrayList<Map<String,Object>>();
		for(Map<String,Object> rstMapObj : rstMap) {
			String str = rstMapObj.get("title").toString();
			String content = Util.removeHtml(str);
			rstMapObj.put("title", content);
			returnMap.add(rstMapObj);
		}
		return returnMap;
	}
