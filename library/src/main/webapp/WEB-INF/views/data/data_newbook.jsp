...
<div class="location">
	<p class="main_p">
		<a href=""><img src="${path}/resources/img/icons/homeicon.PNG"
			style="height: 20px" alt="" /></a> > <a href="" onclick="">이용안내</a> >
		이용안내
	</p>
	<!-- start: 신간안내-->
	<div>
		...
		<table border="1" class="table100">
			<tr>
				...
				<td><select id="search_dy" name="a_dy">
						<option value="2018" selected="selected">2018</option>
						<option value="2017">2017</option>
						<option value="2016">2016</option>
				</select> 년 <br> <%
 	for (int i = 1; i < 7; i++) {
 %> <input id="a_dm<%=i%>" name="a_dm" type="radio"
					value="<%=i%>"> <lable for="a_m<%=i%>"> <%=i%>월</label> <%
 	}
 %> <br>
					<%
						for (int i = 7; i < 13; i++) {
 ...
 %>
			...
			<tr>
				...
				<td><select id="search_dy" name="a_vp">
						<option value="10" selected="selected">10</option>
						<option value="30">30</option>
						<option value="50">50</option>
				</select> 년 <input type="submit" value="검색"></td>
			</tr>
		</table>
	</div>
	<!-- end: 신간안내-->
